...
const Comp = () => {
    ...
    const handleFileConversion = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://3.143.222.88:8000/upload', formData, {
                headers: {
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '10px', }}> <h1>Image Compressor </h1>
        <div className='com1'>
            ...
            {convertedFileUrl && (
                <div>
                    <p>Download your Compressed  file: <a href={convertedFileUrl} download>Click here</a></p>
                    <img src={convertedFileUrl}  controls style={{ width: '300px', marginTop: '20px' }} />
                </div>
            )}
            </div>
        </div>
