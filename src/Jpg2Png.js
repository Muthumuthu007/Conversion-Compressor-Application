...
const Jpg2Png = () => {
    ...
    const handleFileConversion = async () => {
        ...
        formData.append('format', 'png');  //update png to your needs of convertion
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '10px', }}> <h1>JPG  to PNG Converter</h1>
        <div className='com1'>
            ...
            {convertedFileUrl && (
                <div>
                    ...
                    <img src={convertedFileUrl} alt="Converted Image" style={{ width: '300px', marginTop: '20px' }} />
                </div>
            )}
            </div>
        </div>
