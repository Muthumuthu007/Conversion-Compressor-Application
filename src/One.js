...
const One = () => {
    ...
    const handleFileChange = (event) => {
        ...
        setConversionStatus('');  // Reset status when a new file is selected
        setConvertedFileUrl(null); // Clear the previous converted file URL
    };
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '10px', }}> <h1>MP4 to MOV Converter</h1>
        <div className='com1'>
